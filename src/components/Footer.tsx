...
const Footer = () => {
  return (
    ...
    <footer className="footer p-10  bg-slate-900 text-base-200">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-slate-900 text-base-200 border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Your Personal Finance Girl <br/>Financial Literacy and consultation</p>
  </aside> 
